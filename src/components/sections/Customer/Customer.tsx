...
const Customer = () => {
    ...
    return (
        <section className="my-20 py-24">
            <Container>
                <Grid gap="9" justify="center" columns="58% 42%">
                    <Box className="w-full animate__animated animate__backInLeft" data-aos-delay="1000" data-aos="fade-up"> 
                        <figure className="block overflow-hidden relative w-full">
                            <Image src={dictionary.page.customer.left_url} alt="Customer" width={0} height={0} className="w-full h-[45rem] object-cover" />
                    ...
                    <Box className="-mt-28 w-full relative animate__animated animate__backInRight">
                        ...
                        <Text as="p" className="mt-24 leading-8 text-justify max-w-md" size="4" data-aos-delay="1000" data-aos="fade-left">
